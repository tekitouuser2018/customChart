...
var exports$1 = {
	...
	drawIcon: function(ctx, style, radius, x, y, rotation) {
		var type, xOffset, yOffset, size, cornerRadius, xx, yy;
		var rad = (rotation || 0) * RAD_PER_DEG;
...
var element_point = core_element.extend({
	...
	draw: function(chartArea, index) {
		...
		if (chartArea === undefined || helpers$1.canvas._isPointInArea(vm, chartArea)) {
			...
			helpers$1.canvas.drawIcon(ctx, iconType, 20, x, y, rotation);

			// TODO: ポイントの倍の数描画される
			// if (itemCount >= itemLen && itemCount < itemLen*2 ) {
			// 	switch(iconType){

			// 		case STAR :
			// 			helpers$1.canvas.drawPoint(ctx, STAR, 20, x, y, rotation);
